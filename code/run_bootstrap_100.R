...
if(!dir.exists(here::here("results", "bootstrap_100_auc"))){
  dir.create(here::here("results", "bootstrap_100_auc"))
}
...
if (!file.exists(here::here(
  ...
  set.seed(4575)
  folds = vfold_cv(df, v = 10, repeats = 100)
  ...
  saveRDS(results, here::here("results", "bootstrap_100_auc", fname))
