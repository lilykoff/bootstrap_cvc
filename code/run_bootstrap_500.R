...
if(!dir.exists(here::here("results", "bootstrap_500_auc"))){
  dir.create(here::here("results", "bootstrap_500_auc"))
}
...
if (!file.exists(here::here(
  ...
  set.seed(4575)
  folds = vfold_cv(df, v = 10, repeats = 500)
  ...
  saveRDS(results, here::here("results", "bootstrap_500_auc", fname))
