...
if(!dir.exists(here::here("results", "bootstrap_50"))){
  dir.create(here::here("results", "bootstrap_50"))
}
...
if (!file.exists(here::here(
  ...
  set.seed(4575)
  folds = vfold_cv(surv_df, v = 10, repeats = 50)
  ...
  saveRDS(results, here::here("results", "bootstrap_50", fname))
